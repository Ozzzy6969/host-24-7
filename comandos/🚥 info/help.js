        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.MessageEmbed()
                    ...
                    .setFooter({ text: `© desarollado por ｚｅｎ#7743 | 2022`, iconURL: `https://images-ext-1.discordapp.net/external/xjgMSMwoxrstXL68zHhCfREXo4IjSUupP9N4qayHe8I/%3Fsize%3D128/https/cdn.discordapp.com/avatars/747824528075391066/c3a12ce39c5fdf947b63ed3dafd1e56d.png` })
            ...
            .setColor("#6A1B9A")
            .setDescription(`Bot Multifuncional en Desarollo por \`ｚｅｎ#7743\``)
            ...
            .addField(`📈 **__ESTADÍSTICAS__**`, `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 Desarollado por **[ｚｅｎ#7743](https://discord.gg/MBPsvcphGf)**`)
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarollado por ｚｅｎ#7743 | 2022`, iconURL: `https://images-ext-2.discordapp.net/external/G2O3wNQkWm957e5Qv3xUpceIQozUug5Z_dfyP9aIKYQ/%3Fsize%3D4096/https/cdn.discordapp.com/avatars/282942681980862474/c2136834f15c6f8633c19c72feeb2427.webp` })
            ...
            collector.on("collect", async (interaccion) => {
                if (interaccion.isButton()) {
                    ...
                    for (const seleccionado of interaccion.values) {
                        ...
                        .setThumbnail(message.guild.iconURL({ dynamic: true }))
                        .setDescription(comandos_de_categoria.length >= 1 ? `>>> *${comandos_de_categoria.map(comando => `\`${comando.replace(/.js/, "")}\``).join(" - ")}*` : `>>> *Todavía no hay comandos en esta categoría...*`)
                        .setFooter({text: `© desarollado por ｚｅｎ#7743 | 2022`, iconURL: `https://images-ext-2.discordapp.net/external/G2O3wNQkWm957e5Qv3xUpceIQozUug5Z_dfyP9aIKYQ/%3Fsize%3D4096/https/cdn.discordapp.com/avatars/282942681980862474/c2136834f15c6f8633c19c72feeb2427.webp` })
